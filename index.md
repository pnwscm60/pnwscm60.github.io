...
<body>
  ...
  <h3>Graphs and Animations</h3>
	<div id="cont1" style="float:left;width:33%;background-color:#fefefe;padding:10px;border-radius:6px;">
    	...
    	<div style="float:left;border:1px solid #fff;box-shadow:1px 1px 2px #666""><a href="images/aks_de.png" target="_blank">static de (png)></a></div><div style="float:left"><a href="images/aks_en.png" target="_blank">static en (png)</a><br/><a href="images/aksanim_de.svg" target="_blank">animated de (svg)</a><br/><a href="images/aksanim_en.svg" target="_blank">animated en (svg)</a></div>
