<html>
 ...
 @import url("https://fonts.googleapis.com/css?family=Open+Sans+Condensed:300,700");
  ...
  <body>
    ...
    <div><img src="/images/estimate_200427.svg" style="width:100%;"></div>
    <div style="font-size:0.8em;">Estimated Rt for Swiss cantons with over 750 cases as per April 27th. Yellow: Highest density interval (95%).</div>
